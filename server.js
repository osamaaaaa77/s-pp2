...
const words = ["مكياج", "اسنان", "زيتون", "ثور", "كاميرا", "شوكولاته", "بطارية", "طاولة",
  ...
  "طائرة", "ضفدع", "زياد", "تاج", "سنجاب", "دجاج", "طريق", "كوالا", "فراشة",
  ...
  "ملوخية", "كرز", "عشب", "بطيخ", "تلفاز", "طيار", "رسام", "قهوة",
  ...
  "كيلتا", "طبل", "نخلة", "دودة", "برق", "ثلج", "حلاق", "برجر", "مزهرية", "ببغاء",
  "باندا", "يسبح", "ملعقة", "مطعم", "زر", "كنغر", "تفاح", "بقلاوة", "كوب", "زيزو",
  ...
  "قطة", "مسجد", "مفتاح", "دراجة", "كنب", "مطر", "قطار", "نور", "سلحفاة",
  "بلياردو", "مقص", "حقيبة", "شنطة", "هتان", "ضبع", "كلب", "شاورما", "خاتم",
